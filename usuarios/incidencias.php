...
?>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      <?php
      $sql = "SELECT * FROM tb_incidencia WHERE Estado = '0' OR Estado = '1'";
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <a href="historial_detenido.php"> <button type="button" class="btn btn-danger">Incidencia Pausadas: <?php echo $numero ?></button></a>
